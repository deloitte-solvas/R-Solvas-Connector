...
solvas_capital_model_run <- function(sc_da) {
  ...
  # example printing balances for ACCRUED_FEE_PAYABLE
  print(account_balances_by_name$ACCRUED_FEE_PAYABLE)
  ...
  # risk_rating = as.double(assumptions_scalar["RISK_RATING", "property_value"])
  # print(risk_rating)
  ...
  print(assumptions[AP_BBB_CORPORATE_YIELD_BY_RELATIVE,])
  ...
  account_balances$ACCNT_1000[1] = 99 # example settting first period of account #1000 to 99
